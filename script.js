document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Optional: show success state if form is handled via JS/fetch
      if (contactForm.dataset.ajaxSubmit !== undefined) {
        e.preventDefault();
  ...
  if (animatableElements.length > 0) {
    // Set initial state for elements that don't already have the attribute
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אדמתנו ביתנו בע\"מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd1affbb7-1eed-46e1-b6ba-0b0d2cf844d5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd1affbb7-1eed-46e1-b6ba-0b0d2cf844d5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd1affbb7-1eed-46e1-b6ba-0b0d2cf844d5';
